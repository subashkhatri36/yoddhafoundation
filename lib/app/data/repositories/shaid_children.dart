...
// ShaidChildrenRepo shaidChildren = ShaidChildrenRepo();

// class ShaidChildrenRepo {
//   Future<List<ShaidChildren>> getSingleShaidFamily(int shaidID) async {
//     try {
//       var dbClient = await con.db;
//       var res = await dbClient!
//           .query(DBname.shaid, where: 'shaid_id=?', whereArgs: [shaidID]);

//       List<ShaidChildren>? list = res.isNotEmpty
//           ? res.map((c) => ShaidChildren.fromMap(c)).toList()
//           : null;
//       if (list != null) {
//         return list;
//       } else {
...
//       var dbClient = await con.db;
//       int res =
//           await dbClient!.insert(DBname.shaidChildren, shaidChildren.toMap());
//       return res;
//     } catch (error) {
//       return -1;
//     }
...
//           DBname.shaidChildren, shaidChildren.toMap(),
